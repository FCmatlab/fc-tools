...
\fcConfigInsertMatlabVersion*{tools}{0.0.27}{March 22, 2018}{cosmos}{2017a} 
\\ \hline
\end{tabular}
...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/Matlab/fc-tools/0.0.27/fc-tools-0.0.27.tar.gz
$ tar zxf fc-tools-0.0.27.tar.gz
\end{verbatim}
Then under Matlab, one can use \texttt{addpath} command with the \texttt{fc-tools-0.0.27} full path:
\begin{verbatim}
>> addpath('<FULL PATH>/fc-tools-0.0.27')
\end{verbatim}
