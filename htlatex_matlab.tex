...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/fc-tools/0.0.16/mfc-tools-0.0.16.tar.gz
$ tar zxf mfc-tools-0.0.16.tar.gz
\end{verbatim}
Then under Matlab, one can use \texttt{addpath} command with the \texttt{mfc-tools-0.0.16} full path:
\begin{verbatim}
>> addpath('<FULL PATH>/mfc-tools-0.0.16')
\end{verbatim}
