...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/Matlab/fc-tools/0.0.22/mfc-tools-0.0.22.tar.gz
$ tar zxf mfc-tools-0.0.22.tar.gz
\end{verbatim}
Then under Matlab, one can use \texttt{addpath} command with the \texttt{mfc-tools-0.0.22} full path:
\begin{verbatim}
>> addpath('<FULL PATH>/mfc-tools-0.0.22')
\end{verbatim}
