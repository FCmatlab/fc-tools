...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/Matlab/fc-tools/0.0.19/mfc-tools-0.0.19.tar.gz
$ tar zxf mfc-tools-0.0.19.tar.gz
\end{verbatim}
Then under Matlab, one can use \texttt{addpath} command with the \texttt{mfc-tools-0.0.19} full path:
\begin{verbatim}
>> addpath('<FULL PATH>/mfc-tools-0.0.19')
\end{verbatim}
