...
#1 & #2 & 
\begin{tabular}{l}
\BuildLinkWithSizeInKo{\IHTDIR/distrib/Matlab/#1/mfc-tools-#1.tar.gz}
                  {\OHTDIR/#1/mfc-tools-#1.tar.gz}
                  {\includegraphics*{images/icons/tar-gz_40.png}}
\\ 
\BuildLinkWithSizeInKo{\IHTDIR/distrib/Matlab/#1/mfc-tools-#1.zip}
                  {\OHTDIR/#1/mfc-tools-#1.zip}
                  {\includegraphics*{images/icons/zip_new40.png}} 
\\ 
\BuildLinkWithSizeInKo{\IHTDIR/distrib/Matlab/#1/mfc-tools-#1.7z}
                  {\OHTDIR/#1/mfc-tools-#1.7z}
...
\fcInsertVersion{0.0.18}{October 2, 2017} 
\\ \hline
\end{tabular}
