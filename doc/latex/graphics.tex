...
\begin{itemize}
\item[$\bullet$] \fccode{fc_tools.graphics.val2rgb(name)} returns the rgb color associated with the string color \fccode{name}.
\item[$\bullet$] \fccode{fc_tools.graphics.display_colors()} returns the name (login) of the current user as a string.
