...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/Octave/fc-tools/0.0.19/fc-tools-0.0.19.tar.gz
\end{verbatim}
\item Under Octave :
\begin{verbatim}
>> pkg install fc-tools-0.0.19.tar.gz
\end{verbatim}
...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/Octave/fc-tools/0.0.19/fc_tools-0.0.19.tar.gz
$ tar zxvf fc_tools-0.0.19.tar.gz
fc_tools-0.0.19/
fc_tools-0.0.19/DESCRIPTION
fc_tools-0.0.19/COPYING
fc_tools-0.0.19/+fc_tools/
fc_tools-0.0.19/+fc_tools/init.m
...
fc_tools-0.0.19/+fc_tools/version.m
$
\end{verbatim}
Then under Octave, one can use \texttt{addpath} command with the \texttt{fc_tools-0.0.19} full path:
\begin{verbatim}
>> addpath('<FULL PATH>/fc_tools-0.0.19')
\end{verbatim}
