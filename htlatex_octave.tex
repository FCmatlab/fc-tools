...
& 
\begin{tabular}{l}
\BuildLinkWithSizeInKo{\IHTDIR/distrib/Octave/#1/ofc-tools-#1.tar.gz}
                  {\OHTDIR/#1/ofc-tools-#1.tar.gz}
                  {\includegraphics*{images/icons/tar-gz_40.png}}
\\ 
\BuildLinkWithSizeInKo{\IHTDIR/distrib/Octave/#1/ofc-tools-#1.zip}
                  {\OHTDIR/#1/ofc-tools-#1.zip}
                  {\includegraphics*{images/icons/zip_new40.png}} 
\\ 
\BuildLinkWithSizeInKo{\IHTDIR/distrib/Octave/#1/ofc-tools-#1.7z}
...
\fcInsertVersion{\fcTBversion}{October 13, 2017}
\\ \hline
\end{tabular}
