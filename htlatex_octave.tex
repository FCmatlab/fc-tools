...
\def\fcTBversion{0.0.25}
\immediate\write18{mkdir -p \OHTDIR/\fcTBversion}
\begin{tabular}{|M|M|M|M|M|M|}
\hline \\ 
\textbf{Version} & \textbf{date} & \textbf{package} & \textbf{archives} & \textbf{install} & \textbf{User guide} \\ \hline
\fcConfigInsertOctaveVersion*{tools}{0.0.25}{March 6, 2019}{cosmos}{5.1.0}
\\ \hline
\end{tabular}
...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/Octave/fc-tools/0.0.25/fc-tools-0.0.25.tar.gz
\end{verbatim}
\item Under Octave :
\begin{verbatim}
>> pkg install fc-tools-0.0.25.tar.gz
\end{verbatim}
...
\begin{verbatim}
$ wget http://www.math.univ-paris13.fr/~cuvelier/software/codes/Octave/fc-tools/0.0.25/fc_tools-0.0.25.tar.gz
$ tar zxvf fc_tools-0.0.25.tar.gz
fc_tools-0.0.25/
fc_tools-0.0.25/DESCRIPTION
fc_tools-0.0.25/COPYING
fc_tools-0.0.25/+fc_tools/
fc_tools-0.0.25/+fc_tools/init.m
...
fc_tools-0.0.25/+fc_tools/version.m
$
\end{verbatim}
Then under Octave, one can use \texttt{addpath} command with the \texttt{fc_tools-0.0.25} full path:
\begin{verbatim}
>> addpath('<FULL PATH>/fc_tools-0.0.25')
\end{verbatim}
...
\hline \\ 
\textbf{Version} & \textbf{date} & \textbf{package} & \textbf{archives} & \textbf{install} & \textbf{User guide} \\ \hline
\fcConfigInsertOctaveVersion{tools}{0.0.23}{May 14, 2018}{cosmos}{4.4.0}
\\ \hline
\end{tabular}
...
\fcInsertVersion{0.0.22}{April 22, 2018}\\ \hline
